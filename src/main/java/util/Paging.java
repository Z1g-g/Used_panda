...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/used/resources/img/left.gif'></a>");
		}
		else
			sb.append("<img src='/used/resources/img/left.gif'>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='/used/resources/img/right.gif'></a>");
		}
		else
			sb.append("<img src='/used/resources/img/right.gif'>");
//---------------------------------------------------------------------------------------------------------------------	    
